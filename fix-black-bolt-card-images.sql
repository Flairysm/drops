-- Fix Black Bolt card images
-- This script updates the image URLs for Black Bolt cards to ensure they display properly
...
DECLARE
    card_record RECORD;
BEGIN
    RAISE NOTICE 'Black Bolt card images updated:';
    ...
    LOOP
        RAISE NOTICE 'Card: % (Tier: %, Image: %)', 
            ...
            card_record.tier, 
            CASE 
                WHEN card_record.image_url IS NOT NULL THEN 'Has Image'
                ELSE 'No Image'
            END;
    END LOOP;
END $$;
