  ...
  const handleSpin = () => {
    ...
    if (creditBalance < bet) {
      toast({
        ...
        description: `You need ${bet} credits to play. You have ${Math.floor(creditBalance)} credits.`,
        variant: "destructive",
      });
      return;
    }
        ...
        <CardContent className="p-6">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 rounded-lg p-3 border border-green-200 dark:border-green-700 mb-4">
            <div className="flex items-center justify-center space-x-1">
              ...
              >
                Your Credits: {isCreditsLoading ? "Loading..." : (userCredits && typeof userCredits === 'object' && 'credits' in userCredits ? Math.floor(Number((userCredits as any).credits)) : "0")}
              </span>
            </div>
          </div>
